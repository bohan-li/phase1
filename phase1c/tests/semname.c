...
//********************************************************************************************************************************
	...
	char *namenull = '\0';                   // test null
    rc = P1_SemName(sem, name1);
	assert(rc == P1_SUCCESS);
	
	//rc = P1_SemName(sem,namenull);         // test null
...
startup(int argc, char **argv)
{
    ...
    P1SemInit();
//********************************************************************************************************************************
// since name cannot exceed 80, so I made a name whose len is 80
    rc = P1_SemCreate("abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghik", 0, &sem);        
//********************************************************************************************************************************
    assert(rc == P1_SUCCESS);
