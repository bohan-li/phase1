...
startup(int argc, char **argv)
{
	...
	P1ContextFree(11);  	
	P1ContextFree(11);  	
	rc = P1ContextCreate(Output, (void *)333, USLOSS_MIN_STACK, &cid);
	rc = P1ContextCreate(Output, (void *)444, USLOSS_MIN_STACK, &cid);
	P1ContextFree(7);  
	rc = P1ContextCreate(Output, (void *)555, USLOSS_MIN_STACK, &cid);
